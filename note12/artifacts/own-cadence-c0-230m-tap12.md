...
One frozen `LiquidAI/LFM2.5-230M` @ `13a53837c4906b4f7405932532ba85d182bb013b` plays both roles. Pass 1's residual is tapped at layer 12 (last prompt position, detached, train-split centered); pass 2 is a **fresh context** -- null-io's null turn, no system prompt, no retained cache -- with the trained receiver injecting conditioned deltas at layers 4, 6, 8. The 256-dimensional packet is the only carrier.
...
|---|---:|---:|---:|---:|---:|---:|---:|
| 42 | 1.000 | 0.000 | 0.000 | 0.125 | 0.125 | +9.368 | -13.386 |
| 1042 | 0.938 | 0.000 | 0.000 | 0.125 | 0.000 | +8.362 | -12.178 |
| 2042 | 1.000 | 0.000 | 0.000 | 0.125 | 0.125 | +8.661 | -12.780 |
...
| 1042 | 15/16 (0.938) | 0/16 (0.000) | 0/16 (0.000) |
...
|---|---:|---:|---:|---:|---:|
| 42 | 0.125 | 1.000 | 1.000 | 1.000 | 1.000 |
| 1042 | 0.375 | 0.938 | 0.938 | 1.000 | 1.000 |
| 2042 | 0.062 | 1.000 | 1.000 | 1.000 | 1.000 |

## Identity and integrity

| seed | zero dose exact | max abs difference | first gradient | base grads absent | base weights unchanged | cache crossings |
|---|---|---:|---:|---|---|---:|
| 42 | True | 0 | 49.2127 | True | True | 0 |
| 1042 | True | 0 | 46.5302 | True | True | 0 |
| 2042 | True | 0 | 44.4398 | True | True | 0 |
...
* commit `b7515877b16da5cba6747886d3a766b2f6e9f85c`, host `snappy`, device `mps`, dtype `float32`, 1.0 min wall
* registration: tracks/own-cadence/PLAN.md, 2026-08-08 C0 registration
* pass 1 tap: layer 12, 72 features, hidden 1024
