...
Host `LiquidAI/LFM2.5-230M`, budget 4, 81.773 s.
...
| temporal | 42 | 0.00 | 0.00 | None | 0.00 | 0.00 | 40 | 2 |
| temporal | 1042 | 0.00 | 0.00 | None | 0.00 | 0.00 | 40 | 10 |
| temporal | 2042 | 0.00 | 0.00 | None | 0.00 | 0.00 | 40 | 1 |
...
Episode — arm: temporal, seed 1042, chain box->jar->pond, target: black thread
  ...
  tick 2: look() -> that is not a place here
  tick 3: look() -> that is not a place here
  tick 4: remember() -> that did not work
  FAIL (budget) — depth 0/3, 4 of 4 ticks
```
