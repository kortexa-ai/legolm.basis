...
Host `LiquidAI/LFM2.5-230M`, budget 8, 1104.126 s.

| arm | seed | success | depth | ticks | submit | guess | invalid | repeat |
|---|---|---:|---:|---:|---:|---:|---:|---:|
| goal-block | 42 | 1.00 | 3.00 | 4.0 | 1.00 | 0.00 | 0 | 0 |
| goal-block | 1042 | 1.00 | 3.00 | 4.0 | 1.00 | 0.00 | 0 | 0 |
...
| trained-no-goal | 42 | 1.00 | 3.00 | 4.0 | 1.00 | 0.00 | 0 | 0 |
| trained-no-goal | 1042 | 1.00 | 3.00 | 4.0 | 1.00 | 0.00 | 0 | 0 |
| trained-no-goal | 2042 | 1.00 | 3.00 | 4.0 | 1.00 | 0.00 | 0 | 0 |
| shuffled-goal | 42 | 1.00 | 3.00 | 4.0 | 1.00 | 0.00 | 0 | 0 |
| shuffled-goal | 1042 | 1.00 | 3.00 | 4.0 | 1.00 | 0.00 | 0 | 0 |
...
Episode — arm: goal-block, seed 42, chain pond->box->shelf, target: gold bell
  ...
  tick 3: open(shelf) -> you find: gold bell and blue feather
...
Episode — arm: goal-block, seed 42, chain shelf->pond->cabinet, target: gold bell
  ...
  tick 3: open(cabinet) -> you find: gold bell and blue feather
  tick 4: done(gold bell) -> you submit: gold bell
  PASS — depth 3/3, 4 of 8 ticks
```
...
Episode — arm: goal-block, seed 42, chain cabinet->drawer->shelf, target: gold bell
  ...
  tick 3: open(shelf) -> you find: gold bell and black thread
  tick 4: done(gold bell) -> you submit: gold bell
  PASS — depth 3/3, 4 of 8 ticks
```
