...
Host `LiquidAI/LFM2.5-230M` on `cuda` (smarty), epsilon 0.35, T in [4, 8], 322.646 s.
...
| countdown | 1042 | 0.98 | 0.06 | 0.02 | 4.2 | 1.9 | {'4': 3.78, '5': 4.3, '6': 4.1, '7': 4.3, '8': 4.3} |
...
| temporal | 1042 | 1.00 | 0.14 | 0.00 | 4.0 | 2.0 | {'4': 3.0, '5': 4.1, '6': 4.3, '7': 4.3, '8': 4.3} |
...
Episode — arm: temporal, seed 1042, chain drawer->basket->cabinet, target: amber key
  ...
  tick 2: look(basket) -> the light is bad; you cannot read the note
  tick 3: done(amber key) -> you submit: amber key
  PASS — depth 1/3, 3 of 5 ticks, guessed
```
