# V-line rung 2b — LFM2.5-VL-3B, door seed 42
...
Reading at this seed: **(iv) MIXED**. Projection gate 0.99 (passed); weight norm 0.34.

| person-mode | action | boxes | switch | lying | habit | gain | lie cell | silence cost | boxes on empty |
|---|---|---|---|---|---|---|---|---|---|
| social | greet | 0.48 | 0.46 | 0.48 | 0.60 | 0.02 | 0.01 | 0.00 | 0.01 |
| caution | stop | 0.83 | 0.26 | 0.33 | 0.04 | 0.57 | 0.03 | 0.50 | 0.02 |
