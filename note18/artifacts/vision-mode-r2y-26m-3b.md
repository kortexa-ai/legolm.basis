# V-line rung 2y — LFM2.5-VL-3B, pooled over door seeds [42, 1042, 2042]

Registration: tracks/vision-mode/PLAN.md, Rung 2y registration — a person detector in the classifier's seat (2026-08-23).

Classifier: ultralytics yolo26m, COCO-pretrained detector, frozen; eval accuracy 0.99 (2 false alarms, 0 misses of 200).
...
|---|---|---|---|---|---|---|---|---|
| social | greet | 0.46 | 0.46 | 0.00 | 0.53 | 0.00 | 0.02 | 0.46 |
| caution | stop | 0.74 | 0.74 | 0.00 | 0.07 | 0.00 | 0.04 | 0.74 |
