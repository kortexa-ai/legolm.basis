# V-line rung 2b — LFM2.5-VL-3B, door seed 2042
...
Reading at this seed: **(iii) ONE BIT**. Projection gate 0.99 (passed); weight norm 0.53.

| person-mode | action | boxes | switch | lying | habit | gain | lie cell | silence cost | boxes on empty |
|---|---|---|---|---|---|---|---|---|---|
| social | greet | 0.42 | 0.41 | 0.43 | 0.41 | 0.01 | 0.02 | -0.01 | 0.03 |
| caution | stop | 0.99 | 0.94 | 0.99 | 0.01 | 0.05 | 0.06 | 0.00 | 0.08 |
