# V-line rung 1b — LFM2.5-VL-3B, dose ×1, emitter oracle, pooled over door seeds [42, 1042, 2042]

Registration: tracks/vision-mode/PLAN.md, Rung 1b registration — the hostile prompt on the VL host (2026-08-22).

Reading: **(i) PACKET HOLDS** — admissible: True (max parse fallback 0.00, grounding {"social": 0.044444, "caution": 0.022222}).
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| social | greet | 0.49 | 0.03 | 0.28 | 0.50 | 0.47 | 0.00 | — | — | 0.04 | 0.00 |
| caution | stop | 0.76 | 0.00 | 0.41 | 0.97 | 0.09 | 0.00 | 0.62 | split | 0.02 | 0.00 |
